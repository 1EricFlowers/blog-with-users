...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\erice\PycharmProjects\blog-with-users'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\erice\PycharmProjects\blog-with-users\Scripts\deactivate.nu'
